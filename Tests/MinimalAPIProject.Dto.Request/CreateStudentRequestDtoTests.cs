...
public class CreateStudentRequestDtoTests
{
    ...
    {
        // Arrange
        var dto = new CreateStudentRequestDto { Name = "Initial Name", Age = 25 };
    ...
    {
        // Arrange
        var dto1 = new CreateStudentRequestDto { Name = "Student 1", Age = 20 };
        var dto2 = new CreateStudentRequestDto { Name = "Student 2", Age = 25 };
